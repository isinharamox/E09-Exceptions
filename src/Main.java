...
public class Main {
    public static void main(String[] args) {
        ...
        PessoaFisica pF1 = new PessoaFisica("Julaia", "good question", data, "155.495.816-47", 16, 'F');
        PessoaFisica pF2 = new PessoaFisica("Ramox", "fleming", data, "107.010.076-56", 16, 'F');
        PessoaFisica pF3 = new PessoaFisica("Dudete", "contagem", data, "155.495.816-47", 16, 'F');
        PessoaJuridica pJ = new PessoaJuridica("mcdonalt's", "BH", data, "24 405 890/0001-86", "Alimenticio", 25);
